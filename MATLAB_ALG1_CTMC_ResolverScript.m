...
eq40 = N*mu1*x230 == lambda1*x228;
eq41 = N*mu2*x20 == lambda2*x19;
eq42 = (mu1*1 + mu2*19)*x40 == lambda1*x19 + lambda2*x39;
eq43 = (mu1*2 + mu2*18)*x59 == lambda1*x39 + lambda2*x58;
eq44 = (mu1*3 + mu2*17)*x77 == lambda1*x58 + lambda2*x76;
eq45 = (mu1*4 + mu2*16)*x94 == lambda1*x76 + lambda2*x93;
eq46 = (mu1*5 + mu2*15)*x110 == lambda1*x93 + lambda2*x109;
eq47 = (mu1*6 + mu2*14)*x125 == lambda1*x109 + lambda2*x124;
eq48 = (mu1*7 + mu2*13)*x139 == lambda1*x124 + lambda2*x138;
eq49 = (mu1*8 + mu2*12)*x152 == lambda1*x138 + lambda2*x151;
eq50 = (mu1*9 + mu2*11)*x164 == lambda1*x151 + lambda2*x163;
eq51 = (mu1*10 + mu2*10)*x175 == lambda1*x163 + lambda2*x174;
eq52 = (mu1*11 + mu2*9)*x185 == lambda1*x174 + lambda2*x184;
eq53 = (mu1*12 + mu2*8)*x194 == lambda1*x184 + lambda2*x193;
eq54 = (mu1*13 + mu2*7)*x202 == lambda1*x193 + lambda2*x201;
eq55 = (mu1*14 + mu2*6)*x209 == lambda1*x201 + lambda2*x208;
eq56 = (mu1*15 + mu2*5)*x215 == lambda1*x208 + lambda2*x214;
eq57 = (mu1*16 + mu2*4)*x220 == lambda1*x214 + lambda2*x219;
eq58 = (mu1*17 + mu2*3)*x224 == lambda1*x219 + lambda2*x223;
eq59 = (mu1*18 + mu2*2)*x227 == lambda1*x223 + lambda2*x226;
eq60 = (mu1*19 + mu2*1)*x229 == lambda1*x226 + lambda2*x228;
...
ALG_1_SendJobToCloudProbability = 0 + solution.x40 + solution.x59 + solution.x77 + solution.x94 + solution.x110 + solution.x125 + solution.x139 + solution.x152 + solution.x164 + solution.x175 + solution.x185 + solution.x194 + solution.x202 + solution.x209 + solution.x215 + solution.x220 + solution.x224 + solution.x227 + solution.x229;

ALG_1_CloudletUtilization = 1 - solution.x0;
