...
public class RowColumnPagePrinter {
    ...
    private void printPage(int firstIndexOnPage, int lastIndexOnPage, String[] data) {
    ...
    private void printRow(int firstIndexInRow, int lastIndexOnPage, String[] data) {
        for (int column = 0; column < columnsPerPage; column++) {
            int index = firstIndexInRow + column * rowsPerPage;
            if (index <= lastIndexOnPage) printStream.format("%10s", data[index]);
        }
    }
